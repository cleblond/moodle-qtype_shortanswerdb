...
/**
 * Test helpers for the shortanswerdb question type.
 *
 * @package    qtype_shortanswerdb
...
/**
 * Test helper class for the shortanswerdb question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_shortanswerdb_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a shortanswerdb question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_shortanswerdb_question
     */
    public function make_shortanswerdb_question_frogtoad() {
        question_bank::load_question_definition_classes('shortanswerdb');
        $sa = new qtype_shortanswerdb_question();
        ...
        $sa->qtype = question_bank::get_qtype('shortanswerdb');

        return $sa;
    }

    /**
     * Gets the question data for a shortanswerdb question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_shortanswerdb_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'shortanswerdb';
    ...
    /**
     * Gets the question form data for a shortanswerdb question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_shortanswerdb_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a shortanswerdb question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_shortanswerdb_question
     */
    public function make_shortanswerdb_question_frogonly() {
        question_bank::load_question_definition_classes('shortanswerdb');
        $sa = new qtype_shortanswerdb_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a shortanswerdb questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_shortanswerdb_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_shortanswerdb_question
     */
    public function make_shortanswerdb_question_escapedwildcards() {
        question_bank::load_question_definition_classes('shortanswerdb');
        $sa = new qtype_shortanswerdb_question();
        test_question_maker::initialise_a_question($sa);
